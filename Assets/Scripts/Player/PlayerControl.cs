...
public class PlayerControl : PhysicsObject {
    ...
    protected static bool rightBtnPressed;
    
    
    protected static bool btnPressed;
    protected static bool APressed;
    ...
    public void releaseBTN() {
        print(btnPressed);
        if(!APressed && !BPressed && !leftBtnPressed && !rightBtnPressed){
            btnPressed = false;
        }
